              ...
              child: Column(
                ...
                children: [
                  ...
                  ChipInputWidget(
                    ...
                    onAdd: (q) {
                      setState(() {
                        qualificationsRequired.add(q);
                      });
                    },
                    onDelete: (q) {
                      setState(() {
                        qualificationsRequired.remove(q);
                      });
                    },
                  ),
                  ChipInputWidget(
                    ...
                    onAdd: (f) {
                      setState(() {
                        fieldOfStudyRequired.add(f);
                      });
                    },
                    onDelete: (f) {
                      setState(() {
                        fieldOfStudyRequired.remove(f);
                      });
                    },
                  ),
                        ...
                        child: AppTextFormField(
                          ...
                          onTap: () async {
                            ...
                            if (pickedDate != null) {
                              setState(() {
                                examDate = pickedDate;
                                examDateCtrl.text = DateFormat("dd MMM yyyy")
                                    .format(pickedDate);
                              });
                            }
                          },
                          ...
                          onTap: () async {
                            ...
                            if (pickedDate != null) {
                              setState(() {
                                ...
                                resultDateCtrl.text = DateFormat("dd MMM yyyy")
                                    .format(pickedDate);
                              });
                            }
                          },
